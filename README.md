...
| :--- | :--- | :--- |
| **Web App** | [**View Program 1 Code**](https://github.com/tavishsood/Mashup_WebApp) | Next.js & Flask application hosted on Vercel. |
| **CLI Tool** | [**View Program 2 Code**](https://github.com/tavishsood/Mashup_CLI) | Python script (`102303246.py`) implementing the mashup logic locally. |
